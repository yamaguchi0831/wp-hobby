<?php
/**
 * Static first-stage template generated from pages/page-genre-list.html.
 *
        ...
        <main id="main-content">
            <section class="hb__p-subpage-title" aria-label="買取実績">
                <div class="hb__l-container hb__p-subpage-title__inner">
                    <h1 class="hb__p-subpage-title__heading">買取品目一覧</h1>
                </div>
            </section>
            ...
            <div class="hb__l-container hb-page-genre-list__p-cta">
            ...
            <section class="hb__l-section" id="faq">
                <div class="hb__l-container">
                    ...
                    >
                        ...
                        <h2 class="hb-page-genre-list__c-section-head__title">
                            よくある
                            <span class="hb-page-genre-list__c-hl">質問</span>
                        </h2>
                    </header>

                    <div class="hb-page-genre-list__p-faq-list">
                        <article class="hb-page-genre-list__p-faq-item">
                            <button
                                class="hb-page-genre-list__p-faq-question"
                                type="button"
                                aria-expanded="false"
                                data-hb-faq-question
                            >
                                <span
                                    class="hb-page-genre-list__p-faq-icon hb-page-genre-list__p-faq-icon--q"
                                    >Q</span
                                >
                                <span
                                    >送料・査定料・返送料は本当に無料ですか？</span
                                >
                                <span class="hb-page-genre-list__p-faq-toggle"
                                    >＋</span
                                >
                            </button>
                            <div class="hb-page-genre-list__p-faq-answer">
                                <span
                                    class="hb-page-genre-list__p-faq-icon hb-page-genre-list__p-faq-icon--a"
                                    >A</span
                                >
                                <p class="hb-page-genre-list__p-faq-text">
